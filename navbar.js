...
(function () {
  ...
  style.textContent = [
    ...
    'height:100%;display:flex;align-items:center;gap:6px;white-space:nowrap;flex-shrink:0;}',
  ...
  var tickerHTML =
    ...
    svg('<path d="M4 6h16M4 10h16M4 14h10"/>') +
    'Новости</div>' +
    '<div class="om-ticker-track-wrap"><div class="om-ticker-track" id="omTickerTrack"></div></div>' +
    '</div>';
  ...
  var navHTML =
    ...
    'Алатки<span class="om-tools-arrow"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="6,9 12,15 18,9"/></svg></span>' +
    '</button>' +
    '<div class="om-dropdown" id="omDropdown">' +
    '<a href="https://oazamedika.github.io/oaza-medika-website/tools-module/tools.html" class="om-dd-main"><span class="om-dd-icon">' + svg('<circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 010 14.14M4.93 4.93a10 10 0 000 14.14"/>') + '</span>Сите алатки</a>' +
    '<div class="om-dropdown-divider"></div>' +
    '<a href="https://oazamedika.github.io/oaza-medika-website/tools-module/bmi.html"><span class="om-dd-icon">' + svg('<path d="M3 6h18M3 12h10"/><rect x="8" y="3" width="8" height="5" rx="1"/>') + '</span>BMI Калкулатор</a>' +
    '<a href="https://oazamedika.github.io/oaza-medika-website/tools-module/cardiac-dis.html"><span class="om-dd-icon">' + svg('<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>') + '</span>Кардиоваскуларен ризик</a>' +
    '<a href="https://oazamedika.github.io/oaza-medika-website/tools-module/diabetes-risk.html"><span class="om-dd-icon">' + svg('<path d="M12 2.69l5.66 5.66a8 8 0 11-11.31 0z"/>') + '</span>Ризик за дијабет</a>' +
    '</div></li>' +

...
(function () {
  ...
  style.textContent = [
    ...
    /* ── Nav shell ── */
    '.om-nav{position:sticky;top:0;z-index:500;background:rgba(255,255,255,0.97);',
    ...
    'position:fixed;',
    'top:108px;', /* 36px ticker + 72px nav */
    'left:0;right:0;bottom:0;',
    'background:var(--white);',
    'padding:1.5rem 5% 2rem;',
    'border-top:1px solid rgba(42,122,122,.1);',
    'gap:.25rem;',
    'z-index:499;',
    'overflow-y:auto;',
    'align-items:stretch;',
    ...
    '.om-tools-wrap.mobile-open:hover .om-dropdown{display:block;}',
    ...
    '.om-tools-wrap.mobile-open .om-tools-arrow{transform:rotate(180deg);}',
    '}',

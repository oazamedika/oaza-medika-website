...
var HERO_SLIDES = [
  ...
  {
    navLabel : 'Наскоро',
    eyebrow  : 'ПЗУ Оаза Медика · Општина Илинден',
  ...
  {
    navLabel : 'ПУСЗ Оаза',
    eyebrow  : 'ПУСЗ Оаза · Општина Илинден',
    headline : 'Вашето здравје е\n<em>вашата оаза</em>',
    desc     : 'Топла, стручна и достапна лекарска грижа за секој корисник во ПУСЗ Оаза во општина Илинден.',
    images   : [
      'hero/hero2/1.jpg',
      'hero/hero2/2.jpg',
      'hero/hero2/3.jpg'
